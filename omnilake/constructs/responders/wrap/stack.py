...
class LakeConstructResponderWrapStack(Stack):
    def __init__(self, app_name: str, app_base_image: str, architecture: str,
        ...
        self.registered_request_construct_obj = RegisteredRequestConstructObj(
            ...
            registered_type_name='WRAP',
            description='Takes the response from the processor and allows the user to add text before and/or after the response before conclusion.',
            schemas={
        ...
        self.response_generator = EventBusSubscriptionFunction(
            ...
            construct_id='wrap-response-generator',
            event_type=self.registered_request_construct_obj.get_operation_event_name('respond'),
            description='Wraps the response from the processor with text before and/or after the response.',
            entry=self.runtime_path,
            index='response.py',
            handler='final_responder',
            function_name=resource_namer('responder-wrap-handler', scope=self),
