...
_FN_NAME = "omnilake.constructs.archives.vector.entry_tag_extration" 
...
def handler(event: Dict, context: Dict):
    ...
    event_body = ObjectBody(body=source_event.body, schema=VectorArchiveGenerateEntryTagsEventBodySchema)
