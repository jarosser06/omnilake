...
from omnilake.tables.registered_request_constructs.client import RegisteredRequestConstruct


class RegisteredRequestConstructsTable(Stack):
    def __init__(self, app_name: str, deployment_id: str,
        ...
        self.table = DynamoDBTable.from_orm_table_object(
            scope=self,
            table_object=RegisteredRequestConstruct,
        )