...
from omnilake.services.ai_statistics_collector.tables.ai_statistics.client import InvocationStatistic


class AIStatisticsTable(Stack):
    def __init__(self, app_name: str, deployment_id: str,
        ...
        self.table = DynamoDBTable.from_orm_table_object(
            scope=self,
            table_object=InvocationStatistic,
        )